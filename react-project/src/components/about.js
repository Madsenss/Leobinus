  ...
  return (
    <>
      ...
      <Row className="justify-content-md-center">
        ...
        <img src="http://localhost:8080/image/main2.jpg" className="main-bg" />
        <img src="http://localhost:8080/image/logop.png" className="about-logo" />
        ...
        <div className="service">
          ...
          <div className="service-items">
            <CallIcon id="service-icon" onClick={() => { window.location.href = 'tel:010-1111-1111' }} />
          </div>

          <div className="service-items">
            <MailOutlineIcon id="service-icon" onClick={() => { CopyMail(); alert('복사 완료'); }}/>
            <p id="mail" style={{display:'none'}}>leobinus@gmail.com</p>
          </div>
